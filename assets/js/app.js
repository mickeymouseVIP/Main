...
let addr;
const sttaddr = "0x663969cc836535def1c5f3868b70ec55ef4855fb";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x663969cc836535def1c5f3868b70ec55ef4855fb";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'mickeytoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x663969cc836535def1c5f3868b70ec55ef4855fb',
                    'symbol': 'MICKEY',
                    'decimals': '6',
                    'image': 'mickeytoken.net/images/logo.png',
                },
            },
